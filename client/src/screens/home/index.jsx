    ...
    <div className={styles.container}>
      ...
      <div className={styles.card4}>
        ...
        <p>
          Вы получите{" "}
          <span className="highlight-green">
            новые вещи из ваших же текстильных материалов
          </span>
          ,<br /> потому что мы переработаем использованный текстиль с
          применением самых инновационных технологий, продлив тем самым его
          жизненный цикл.
        </p>
        <div>
      ...
      <div className={styles.card7}>
        <div>
          ...
          <p>
            Цель проекта <span>FabRevizion</span> – чтобы наши клиенты,
            связанные с производством и эксплуатацией текстильной продукции, а
            также все осознанные потребители получили инновационные экологичные
            решения по уходу за использованным текстилем и остатками
            текстильного производства.  </p>    <p>   
            
            Только вместе сделаем мир лучше!
          </p>   
          <BackToTop />
        </div>
      </div>
