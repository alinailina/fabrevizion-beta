    ...
    <div>
      ...
      <div className={styles.principles}>
        <p>
          ...
          &mdash; чтобы наши клиенты, связанные с производством и эксплуатацией
        ...
        <p>
          Вместе мы выстраиваем новые бизнес-процессы, направленные на
          уменьшение экологического ущерба и обеспечение процветания для всех
          при положительном экономическом росте. Мы стремимся чтобы новые
        ...
        <p>
          ...
          среде и людям, осознанного развития бизнеса и ответственности за свои
          слова и действия, присоединяйтесь в нашу цепочку взаимодействий, ведь
          только вместе мы сможем спасти Планету!
        </p>
      </div>
    </div>
  );
