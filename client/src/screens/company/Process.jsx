    ...
    <div className={styles.process}>
      ...
      <ul>
        <li>
          ...
          <div>
            <img
              src={require("../../assets/process_step1.svg")}
              alt="old-garments"
            />
          </div>
          <div>
        ...
        <li>
          ...
          <div>
            <img
              src={require("../../assets/process_step2.svg")}
        ...
        <li>
          ...
          <div>
            <img
              src={require("../../assets/process_step3.svg")}
          ...
          <div>
            ...
            <p>
              ...
              <Link to="магазин">новую униформу</Link> по нашим моделям или по
              Вашему тех. заданию, а также другие изделия, разработанные нашими
              дизайнерами.
            </p>
            <p>
        ...
        <li>
          ...
          <div>
            <img
              src={require("../../assets/process_step4.svg")}
        ...
        <li>
          ...
          <div>
            <img
              src={require("../../assets/process_step5.svg")}
